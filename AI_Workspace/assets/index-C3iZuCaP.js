...
对话规则：
1. 你就是这个角色本人，用第一人称"我"说话，不要用第三人称描述自己
2. 保持角色性格，用角色的语气说话
3. 回复简洁，50-200字
4. 用「」包裹对话内容
5. 动作描写也用第一人称（如"我微微一笑"），不要用"他微微一笑"或"沈夜尘微微一笑"
6. 不要用*号做动作描写
7. 直接对玩家说话，就像面对面聊天一样
...
「破道，是打破天道的束缚，也是打破命运的枷锁。」`}]},mc={class:`game-bg`},hc={class:`bg-stars`},gc={class:`top-bar`},_c={class:`chapter-info`},vc={class:`chapter-badge`},yc={class:`dialog-area`},bc=[`innerHTML`],xc=[`onClick`],Sc={class:`choice-text`},Cc={key:1,class:`ai-history`},wc={class:`ai-msg-role`},Tc={class:`ai-msg-text`},Ec={key:0,class:`ai-msg ai-msg-char`},Dc={class:`ai-msg-role`},Oc={key:2,class:`continue-hint`},kc=[`placeholder`,`disabled`],Ac=[`disabled`],jc={class:`name-card`},Mc={class:`bottom-status`},Nc={class:`attr-mini`},Pc={class:`attr-mini`},Fc={class:`attr-mini`},Ic=Bs(Object.assign({methods:{formatText(e){return e?e.replace(/\n/g,`<br>`).replace(/「([^」]+)」/g,`<span class="quote">「$1」</span>`).replace(/——/g,`<span class="dash">——</span>`):``}}},{__name:`GameScreen`,emits:[`show-attr`,`show-affection`,`back-to-menu`],setup(e,{emit:t}){Js(0,rc),Js(1,ic),Js(2,ac),Js(3,oc),Js(4,sc),Js(5,cc),Js(6,lc),Js(7,uc),Js(8,dc),Js(9,fc),Js(10,pc);let n=t,r=R(``),i=R(!1),a=R(!1),o=R(!1),s=R(`沈熏`),c=R(null),l=R(null),u=R(!1),d=R([]),f=R(``),p=R(!1),m=R(null),h=xa(()=>Ys()),g=xa(()=>Xs()),_=xa(()=>{let e=h.value?.speaker||``;return e===`沈夜尘`?`#c8d8e8`:e===`顾长渊`?`#d4c490`:e===`楚惊鸿`?`#e8a0a0`:e===`林若薇`?`#b8e0b8`:e===`旁白`?`var(--text-dim)`:e===`系统`?`var(--gold)`:`var(--text)`}),v=xa(()=>i.value?ec():[]);function y(){let e=h.value;e&&(r.value=e.text||``,i.value=!!e.choices,e.ai?(u.value=!0,d.value=[],f.value=``):u.value=!1,pn(()=>{c.value&&(c.value.scrollTop=0)}),e.speaker&&e.speaker!==`系统`&&e.text&&zs(e.text,e.speaker))}function b(){c.value&&(c.value.scrollTop=c.value.scrollHeight)}function x(){if(i.value||o.value||u.value)return;let e=h.value;if(!e)return;if(e.input){o.value=!0;return}if(e.nextChapter!==void 0){nc(),Zs($.scene),y();return}let t=tc();t&&(Zs(t),y())}function S(){$.playerName=s.value||`沈熏`,o.value=!1;let e=tc();e&&(Zs(e),y())}function C(e){let t=Qs(e.originalIndex);t&&(i.value=!1,Zs(t),y())}async function w(){let e=f.value.trim();if(!e||p.value)return;let t=h.value;if(!t?.ai)return;d.value.push({role:`user`,content:e}),f.value=``,p.value=!0,pn(()=>b()),m.value&&m.value.abort();let n=new AbortController;m.value=n;try{let{content:e,shouldTransition:r}=await Cs(t.ai.character,t.ai.context,t.ai.transitionHint,d.value,{signal:n.signal});if(n.signal.aborted)return;d.value.push({role:`assistant`,content:e}),pn(()=>b()),zs(e,t.ai.character),r&&t.ai.nextScene&&setTimeout(()=>{u.value=!1,Zs(t.ai.nextScene),y()},1500)}catch(e){if(e.name===`AbortError`)return;d.value.push({role:`assistant`,content:`（对话出现错误：`+e.message+`）`}),pn(()=>b())}finally{n.signal.aborted||(p.value=!1)}}function T(){let e=h.value;e?.ai?.nextScene&&(m.value&&m.value.abort(),u.value=!1,Rs(),Zs(e.ai.nextScene),y())}function ee(){a.value=!a.value}return Zs($.scene),y(),(e,t)=>(q(),J(`div`,{class:`game-root`,onClick:x},[Y(`div`,mc,[Y(`div`,hc,[(q(),J(W,null,Sr(30,e=>Y(`div`,{key:e,class:`star`,style:A({"--x":`${Math.random()*100}%`,"--y":`${Math.random()*100}%`,"--d":`${1+Math.random()*3}s`})},null,4)),64))])]),Y(`div`,gc,[Y(`div`,_c,[Y(`span`,vc,j(g.value),1)]),Y(`button`,{class:`menu-toggle`,onClick:Uo(ee,[`stop`])},`☰`)]),X(La,{name:`fade`},{default:wn(()=>[a.value?(q(),J(`div`,{key:0,class:`dropdown-menu`,onClick:t[3]||=Uo(()=>{},[`stop`])},[Y(`button`,{onClick:t[0]||=e=>{n(`show-attr`),a.value=!1}},`📜 属性面板`),Y(`button`,{onClick:t[1]||=e=>{n(`show-affection`),a.value=!1}},`💕 好感度`),Y(`button`,{onClick:t[2]||=e=>{z(Rs)(),n(`back-to-menu`),a.value=!1}},`🏠 返回主菜单`)])):Z(``,!0)]),_:1}),Y(`div`,yc,[Y(`div`,{class:`dialog-content`,ref_key:`textContainer`,ref:c},[h.value?.speaker?(q(),J(`div`,{key:0,class:`speaker`,style:A({color:_.value})},j(h.value.speaker===`系统`?``:h.value.speaker),5)):Z(``,!0),Y(`div`,{class:`text-body`,innerHTML:e.formatText(r.value)},null,8,bc),X(La,{name:`fade-up`},{default:wn(()=>[i.value&&v.value.length?(q(),J(`div`,{key:0,class:`choices-container`,ref_key:`choicesRef`,ref:l},[(q(!0),J(W,null,Sr(v.value,e=>(q(),J(`button`,{key:e.originalIndex,class:`choice-btn`,onClick:Uo(t=>C(e),[`stop`])},[t[8]||=Y(`span`,{class:`choice-marker`},`▸`,-1),Y(`span`,Sc,j(e.text),1)],8,xc))),128))],512)):Z(``,!0)]),_:1}),u.value&&d.value.length?(q(),J(`div`,Cc,[(q(!0),J(W,null,Sr(d.value,(e,t)=>(q(),J(`div`,{key:t,class:me([`ai-msg`,e.role===`user`?`ai-msg-user`:`ai-msg-char`])},[Y(`span`,wc,j(e.role===`user`?s.value:h.value?.ai?.character||``),1),Y(`span`,Tc,j(e.content),1)],2))),128)),p.value?(q(),J(`div`,Ec,[Y(`span`,Dc,j(h.value?.ai?.character||``),1),t[9]||=Y(`span`,{class:`ai-msg-text ai-typing`},`思考中...`,-1)])):Z(``,!0)])):Z(``,!0),!i.value&&!o.value&&!u.value?(q(),J(`div`,Oc,[...t[10]||=[Y(`span`,{class:`blink`},`▼`,-1)]])):Z(``,!0)],512),u.value?(q(),J(`div`,{key:0,class:`ai-input-area`,onClick:t[5]||=Uo(()=>{},[`stop`])},[Tn(Y(`input`,{"onUpdate:modelValue":t[4]||=e=>f.value=e,class:`ai-input`,placeholder:`对${h.value?.ai?.character||`角色`}说些什么...`,onKeyup:Go(w,[`enter`]),disabled:p.value},null,40,kc),[[Po,f.value]]),Y(`button`,{class:`ai-send-btn`,onClick:w,disabled:p.value||!f.value.trim()},` 发送 `,8,Ac),Y(`button`,{class:`ai-skip-btn`,onClick:T},` 跳过 `)])):Z(``,!0)]),X(La,{name:`fade`},{default:wn(()=>[o.value?(q(),J(`div`,{key:0,class:`name-modal`,onClick:t[7]||=Uo(()=>{},[`stop`])},[Y(`div`,jc,[t[11]||=Y(`h3`,null,`请为你的角色取名`,-1),Tn(Y(`input`,{"onUpdate:modelValue":t[6]||=e=>s.value=e,class:`name-input`,placeholder:`沈熏`,maxlength:`8`,onKeyup:Go(S,[`enter`])},null,544),[[Po,s.value]]),Y(`button`,{class:`name-confirm`,onClick:S},`确认`)])])):Z(``,!0)]),_:1}),Y(`div`,Mc,[Y(`span`,Nc,`修为:`+j(z($).attributes.cultivation),1),Y(`span`,Pc,`魅力:`+j(z($).attributes.charm),1),Y(`span`,Fc,`神秘:`+j(z($).attributes.mystery),1)])]))}}),[[`__scopeId`,`data-v-ca325b6a`]]),Lc={class:`panel`},Rc={class:`panel-header`},zc={class:`panel-body`},Bc={class:`attr-grid`},Vc={class:`attr-icon`},Hc={class:`attr-info`},Uc={class:`attr-label`},Wc={key:0,class:`attr-bar`},Gc={key:1,class:`attr-bar`},Kc=Bs({__name:`AttributePanel`,emits:[`close`],setup(e,{emit:t}){let n=t,r=[{key:`cultivation`,label:`修为`,icon:`⚡`},{key:`spiritPower`,label:`灵力`,icon:`💎`},{key:`rootBone`,label:`根骨`,icon:`🦴`},{key:`charm`,label:`魅力`,icon:`✨`},{key:`physique`,label:`体质`,icon:`💪`},{key:`wisdom`,label:`智慧`,icon:`📖`},{key:`mind`,label:`心性`,icon:`🧘`},{key:`fortune`,label:`机缘`,icon:`🎲`},{key:`morality`,label:`道德值`,icon:`⚖️`},{key:`mystery`,label:`神秘值`,icon:`🔮`},{key:`harem`,label:`后宫值`,icon:`💕`}];function i(e){return e<=20?`魔道`:e<=40?`灰色`:e<=60?`中庸`:e<=80?`正道`:`圣道`}return(e,t)=>(q(),J(`div`,{class:`panel-overlay`,onClick:t[1]||=Uo(e=>n(`close`),[`self`])},[Y(`div`,Lc,[Y(`div`,Rc,[Y(`h2`,null,j(z($).playerName)+` · 属性面板`,1),Y(`button`,{class:`close-btn`,onClick:t[0]||=e=>n(`close`)},`✕`)]),Y(`div`,zc,[Y(`div`,Bc,[(q(),J(W,null,Sr(r,e=>Y(`div`,{key:e.key,class:`attr-card`},[Y(`div`,Vc,j(e.icon),1),Y(`div`,Hc,[Y(`div`,Uc,j(e.label),1),Y(`div`,{class:me([`attr-value`,{highlight:e.key===`charm`}])},[e.key===`rootBone`?(q(),J(W,{key:0},[Yi(j(z($).attributes.rootBone),1)],64)):e.key===`morality`?(q(),J(W,{key:1},[Yi(j(z($).attributes.morality)+` (`+j(i(z($).attributes.morality))+`) `,1)],64)):(q(),J(W,{key:2},[Yi(j(z($).attributes[e.key]),1)],64))],2)]),typeof z($).attributes[e.key]==`number`&&e.key!==`charm`?(q(),J(`div`,Wc,[Y(`div`,{class:`bar-fill`,style:A({width:`${Math.min(100,z($).attributes[e.key])}%`})},null,4)])):Z(``,!0),e.key===`charm`?(q(),J(`div`,Gc,[...t[2]||=[Y(`div`,{class:`bar-fill charm-fill`,style:{width:`100%`}},null,-1)]])):Z(``,!0)])),64))])])])]))}},[[`__scopeId`,`data-v-c739786b`]]),qc={class:`panel`},Jc={class:`panel-header`},Yc={class:`panel-body`},Xc={class:`char-list`},Zc={class:`char-info`},Qc={class:`char-title`},$c={class:`char-desc`},el={class:`affection-row`},tl={class:`affection-bar`},nl={class:`affection-info`},rl={class:`affection-value`},il={class:`harem-section`},al={class:`harem-bar`},ol={class:`harem-value`},sl=Bs({__name:`AffectionPanel`,emits:[`close`],setup(e,{emit:t}){let n=t,r=[{key:`shen_yechen`,name:`沈夜尘`,title:`腹黑师弟 · 九尾天狐之后`,color:`#c8d8e8`,icon:`🦊`,desc:`表面软糯无害，实则城府极深`},{key:`gu_changyuan`,name:`顾长渊`,title:`纯情大夫 · 万年药童转世`,color:`#d4c490`,icon:`🌿`,desc:`万人迷活菩萨，遇到感情就脸红`},{key:`chu_jinghong`,name:`楚惊鸿`,title:`纨绔少主 · 天机商会继承人`,color:`#e8a0a0`,icon:`⚡`,desc:`嘴硬心软的傲娇小狼狗`}];function i(e){return e===`执念`?`#d45353`:e===`挚爱`?`#e8a0bf`:e===`心动`?`#d4a853`:e===`熟悉`?`#7eb8da`:e===`认识`?`#7ec87e`:`#a090b0`}return(e,t)=>(q(),J(`div`,{class:`panel-overlay`,onClick:t[1]||=Uo(e=>n(`close`),[`self`])},[Y(`div`,qc,[Y(`div`,Jc,[t[2]||=Y(`h2`,null,`💕 好感度`,-1),Y(`button`,{class:`close-btn`,onClick:t[0]||=e=>n(`close`)},`✕`)]),Y(`div`,Yc,[Y(`div`,Xc,[(q(),J(W,null,Sr(r,e=>Y(`div`,{key:e.key,class:`char-card`},[Y(`div`,{class:`char-avatar`,style:A({borderColor:e.color})},j(e.icon),5),Y(`div`,Zc,[Y(`div`,{class:`char-name`,style:A({color:e.color})},j(e.name),5),Y(`div`,Qc,j(e.title),1),Y(`div`,$c,j(e.desc),1),Y(`div`,el,[Y(`div`,tl,[Y(`div`,{class:`bar-fill`,style:A({width:`${z($).affection[e.key]}%`,background:`linear-gradient(90deg, ${e.color}88, ${e.color})`})},null,4)]),Y(`div`,nl,[Y(`span`,rl,j(z($).affection[e.key]),1),Y(`span`,{class:`affection-stage`,style:A({color:i(z($).affectionStage[e.key])})},j(z($).affectionStage[e.key]),5)])])])])),64))]),Y(`div`,il,[t[3]||=Y(`div`,{class:`harem-label`},`后宫值`,-1),Y(`div`,al,[Y(`div`,{class:`harem-fill`,style:A({width:`${Math.min(100,z($).attributes.harem)}%`})},null,4)]),Y(`div`,ol,j(z($).attributes.harem),1)])])])]))}},[[`__scopeId`,`data-v-1692d030`]]),cl={class:`app-root`},ll={class:`settings-card`},ul={class:`settings-header`},dl={class:`settings-body`},fl={class:`preset-bar`},pl=[`value`],ml=[`value`],hl=[`value`],gl=[`value`],_l=[`disabled`],vl={key:0,class:`settings-error`},yl=[`value`],bl=[`value`],xl={key:1,class:`settings-hint`,style:{"text-align":`center`,padding:`12px 0`}},Sl={class:`toggle-row`},Cl=[`value`],wl=[`value`],Tl=[`value`],El=[`value`],Dl=[`value`],Ol=[`value`];Yo({__name:`App`,setup(e){let t=R(`menu`),n=R(!1),r=R(!1),i=R(!1),a=R(ms()),o=R(hs()?.id||null),s=R([]),c=R(!1),l=R(``),u=xa(()=>a.value.find(e=>e.id===o.value)||null);function d(){gs(o.value)}function f(){let e=_s();a.value=ms(),o.value=e.id,s.value=[]}function p(){o.value&&(ys(o.value),a.value=ms(),o.value=hs()?.id||null,s.value=[])}function m(e,t){o.value&&(vs(o.value,{[e]:t}),a.value=ms())}async function h(){let e=u.value;if(!e||!e.baseUrl||!e.apiKey){l.value=`请先填写 URL 和 Key`;return}c.value=!0,l.value=``;try{s.value=await bs(e.baseUrl,e.apiKey),s.value.length||(l.value=`未获取到模型列表`)}catch(e){l.value=`拉取失败: `+e.message}finally{c.value=!1}}let g=R(ws()),_=R(js());function v(){Ts(g.value)}function y(){Ms(_.value)}jn(i,e=>{e&&(a.value=ms(),o.value=hs()?.id||null,g.value=ws(),s.value=[],l.value=``)});function b(){as(),t.value=`game`}function x(){rs()&&(t.value=`game`)}function S(){n.value=!0}function C(){r.value=!0}return(e,w)=>(q(),J(`div`,cl,[Y(`button`,{class:`settings-btn`,onClick:w[0]||=e=>i.value=!0},`⚙`),t.value===`menu`?(q(),Vi(Ks,{key:0,"has-save":z(is)(),onNewGame:b,onContinue:x},null,8,[`has-save`])):Z(``,!0),t.value===`game`?(q(),Vi(Ic,{key:1,onShowAttr:S,onShowAffection:C,onBackToMenu:w[1]||=e=>t.value=`menu`})):Z(``,!0),X(La,{name:`slide-up`},{default:wn(()=>[n.value?(q(),Vi(Kc,{key:0,onClose:w[2]||=e=>n.value=!1})):Z(``,!0)]),_:1}),X(La,{name:`slide-up`},{default:wn(()=>[r.value?(q(),Vi(sl,{key:0,onClose:w[3]||=e=>r.value=!1})):Z(``,!0)]),_:1}),X(La,{name:`fade`},{default:wn(()=>[i.value?(q(),J(`div`,{key:0,class:`settings-overlay`,onClick:w[15]||=Uo(e=>i.value=!1,[`self`])},[Y(`div`,ll,[Y(`div`,ul,[w[16]||=Y(`h2`,null,`⚙ 设置`,-1),Y(`button`,{class:`close-btn`,onClick:w[4]||=e=>i.value=!1},`✕`)]),Y(`div`,dl,[w[25]||=Y(`div`,{class:`section-title`},`LLM 对话`,-1),Y(`div`,fl,[Tn(Y(`select`,{class:`settings-select`,"onUpdate:modelValue":w[5]||=e=>o.value=e,onChange:d},[(q(!0),J(W,null,Sr(a.value,e=>(q(),J(`option`,{key:e.id,value:e.id},j(e.name||`未命名`),9,pl))),128))],544),[[Lo,o.value]]),Y(`button`,{class:`icon-btn`,onClick:f,title:`新建预设`},`+`),Y(`button`,{class:`icon-btn danger`,onClick:p,title:`删除预设`},`🗑`)]),u.value?(q(),J(W,{key:0},[w[19]||=Y(`label`,{class:`settings-label`},`名称`,-1),Y(`input`,{class:`settings-input`,value:u.value.name,onInput:w[6]||=e=>m(`name`,e.target.value),placeholder:`预设名称`},null,40,ml),w[20]||=Y(`label`,{class:`settings-label`},`Base URL`,-1),Y(`input`,{class:`settings-input`,value:u.value.baseUrl,onInput:w[7]||=e=>m(`baseUrl`,e.target.value),placeholder:`https://api.example.com/v1`},null,40,hl),w[21]||=Y(`label`,{class:`settings-label`},`API Key`,-1),Y(`input`,{class:`settings-input`,type:`password`,value:u.value.apiKey,onInput:w[8]||=e=>m(`apiKey`,e.target.value),placeholder:`sk-...`},null,40,gl),Y(`button`,{class:`settings-action`,onClick:h,disabled:c.value},j(c.value?`拉取中...`:`拉取模型列表`),9,_l),l.value?(q(),J(`div`,vl,j(l.value),1)):Z(``,!0),s.value.length?(q(),J(W,{key:1},[w[18]||=Y(`label`,{class:`settings-label`},`模型`,-1),Y(`select`,{class:`settings-select full`,value:u.value.model,onChange:w[9]||=e=>m(`model`,e.target.value)},[w[17]||=Y(`option`,{value:``},`请选择模型`,-1),(q(!0),J(W,null,Sr(s.value,e=>(q(),J(`option`,{key:e,value:e},j(e),9,bl))),128))],40,yl)],64)):Z(``,!0)],64)):(q(),J(`div`,xl,`点击 [+] 添加一个 API 预设`)),w[26]||=Y(`div`,{class:`section-title`,style:{"margin-top":`20px`}},`TTS 语音`,-1),Y(`label`,Sl,[w[22]||=Y(`span`,{class:`settings-label`,style:{"margin-bottom":`0`}},`语音播放`,-1),Tn(Y(`input`,{type:`checkbox`,"onUpdate:modelValue":w[10]||=e=>_.value=e,onChange:y},null,544),[[Fo,_.value]]),w[23]||=Y(`span`,{class:`toggle-track`},[Y(`span`,{class:`toggle-thumb`})],-1)]),w[27]||=Y(`label`,{class:`settings-label`},`Base URL`,-1),Y(`input`,{class:`settings-input`,value:g.value.baseUrl,onChange:w[11]||=e=>{g.value.baseUrl=e.target.value,v()},placeholder:`https://api.example.com/v1`},null,40,Cl),w[28]||=Y(`label`,{class:`settings-label`},`API Key`,-1),Y(`input`,{class:`settings-input`,type:`password`,value:g.value.apiKey,onChange:w[12]||=e=>{g.value.apiKey=e.target.value,v()},placeholder:`sk-...`},null,40,wl),w[29]||=Y(`label`,{class:`settings-label`},`模型`,-1),Y(`select`,{class:`settings-select full`,value:g.value.model,onChange:w[13]||=e=>{g.value.model=e.target.value,v()}},[(q(!0),J(W,null,Sr(z(Es),e=>(q(),J(`option`,{key:e.id,value:e.id},j(e.name),9,El))),128))],40,Tl),w[30]||=Y(`label`,{class:`settings-label`},`语音`,-1),Y(`select`,{class:`settings-select full`,value:g.value.voice,onChange:w[14]||=e=>{g.value.voice=e.target.value,v()}},[w[24]||=Y(`option`,{value:``},`默认`,-1),(q(!0),J(W,null,Sr(z(Ds),e=>(q(),J(`option`,{key:e.id,value:e.id},j(e.name),9,Ol))),128))],40,Dl)])])])):Z(``,!0)]),_:1})]))}}).mount(`#app`);